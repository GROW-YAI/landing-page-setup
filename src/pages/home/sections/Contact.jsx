    ...
    <div className="relative flex flex-col items-center bg-gradient-to-r from-[#7aa709] to-[#1B75BC] text-white py-12 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-5xl w-full">
        {[
          ...
          <div
            key={index}
            className="bg-white text-[#1B75BC] p-6 text-center rounded-lg shadow-lg transition-transform duration-300 hover:scale-105 cursor-pointer"
      ...
      <div className="bg-[#1B75BC] text-white mt-8 p-8 rounded-lg shadow-lg max-w-2xl w-full">
        ...
        <form className="space-y-4">
          ...
          ></textarea>
          <button
            className="w-full bg-[#7aa709] text-white py-2 rounded-md hover:bg-[#145a92] transition duration-300"
            type="submit"
          >
            SUBMIT
          </button>
